...
*Screenshots to be added in a subsequent update.*
...
- **ChatGPT Plus** — development assistance throughout
...
PlayAnalytics was built end-to-end solo: from data sourcing and model training to full-stack deployment and user validation. The full product lifecycle: problem framing, data collection, feature engineering, model benchmarking (Random Forest vs SVM vs XGBoost), Django app development, and a 17-respondent post-development survey.

Background is 20 years in operations and people systems, not computer science. The Django foundation came from the Python Crash Course book. Everything else: scikit-learn, Chart.js, Bootstrap, feature engineering, model serialization, was built by working through DataCamp, Udemy, YouTube, and the project itself.
